...
module.exports = {
  'license': 'MIT',
  'homepage': 'https://github.com/usefulcoin/express-pixelarity-linear-initialization',
  'author': {
  ...
  'repository': {
      'type': 'git',
      'url': 'https://github.com/usefulcoin/express-pixelarity-linear-initialization.git'
  },
  'scripts': {
    'clean': 'rm -rf dist/*',
...
unzip ../linear.zip -d /tmp && mv /tmp/purple linear && echo [$0] unzipped template archive.
